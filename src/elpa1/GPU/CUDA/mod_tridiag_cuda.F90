...
module tridiag_cuda
  ...
  interface
    subroutine cuda_dot_product_double_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug_int, sm_count, my_stream) &
  ...
  interface
    subroutine cuda_dot_product_and_assign_double_c(v_row_dev, l_rows, isOurProcessRow_int, aux1_dev, &
  ...
  interface
    subroutine cuda_set_e_vec_scale_set_one_store_v_row_double_c(e_vec_dev, vrl_dev, a_dev, v_row_dev, &
  ...
  interface
    subroutine cuda_hh_transform_double_c(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug_int, my_stream) &
  ...
  interface
    subroutine cuda_dot_product_float_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug_int, sm_count, my_stream) &
  ...
  interface
    subroutine cuda_dot_product_and_assign_float_c(v_row_dev, l_rows, isOurProcessRow_int, aux1_dev, &
                                                  wantDebug_int, my_stream) &
  ...
  interface
    subroutine cuda_set_e_vec_scale_set_one_store_v_row_float_c(e_vec_dev, vrl_dev, a_dev, v_row_dev, &
                                     tau_dev, xf_host_or_dev, &
                                     l_rows, l_cols, matrixRows, istep, isOurProcessRow_int, useCCL_int, wantDebug_int, my_stream) &
  ...
  interface
    subroutine cuda_hh_transform_float_c(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug_int, my_stream) &
  ...
  interface
    subroutine cuda_dot_product_double_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug_int, sm_count, my_stream) &
                                                  bind(C, name="cuda_dot_product_double_complex_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t), value  :: x_dev, y_dev, result_dev
      integer(kind=c_int), intent(in)  :: n, incx, incy, sm_count
  ...
  interface
    subroutine cuda_dot_product_and_assign_double_complex_c(v_row_dev, l_rows, isOurProcessRow_int, aux1_dev, &
                                                  wantDebug_int, my_stream) &
                                                  bind(C, name="cuda_dot_product_and_assign_double_complex_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t), value  :: v_row_dev, aux1_dev
      integer(kind=c_int), intent(in)  :: l_rows
  ...
  interface
    subroutine cuda_set_e_vec_scale_set_one_store_v_row_double_complex_c(e_vec_dev, vrl_dev, a_dev, v_row_dev, &
                                     tau_dev, xf_host_or_dev, &
                                     l_rows, l_cols, matrixRows, istep, isOurProcessRow_int, useCCL_int, wantDebug_int, my_stream) &
                                     bind(C, name="cuda_set_e_vec_scale_set_one_store_v_row_double_complex_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t), value  :: e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, xf_host_or_dev
      integer(kind=c_int), intent(in)  :: l_rows, l_cols, matrixRows, istep
  ...
  interface
    subroutine cuda_store_u_v_in_uv_vu_double_complex_c(vu_stored_rows_dev, uv_stored_cols_dev, v_row_dev, u_row_dev, &
                                                  ...
                                                  l_rows, l_cols, n_stored_vecs, max_local_rows, max_local_cols, istep, &
                                                  useCCL_int, wantDebug_int, my_stream) &
                                                  bind(C, name="cuda_store_u_v_in_uv_vu_double_complex_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t), value  :: vu_stored_rows_dev, uv_stored_cols_dev, v_row_dev, u_row_dev
      integer(kind=c_intptr_t), value  :: v_col_dev, u_col_dev, tau_dev, aux_complex_dev
  ...
  interface
    subroutine cuda_update_matrix_element_add_double_complex_c(vu_stored_rows_dev, uv_stored_cols_dev, a_dev, d_vec_dev, &
                                             l_rows, l_cols, matrixRows, max_local_rows, max_local_cols, istep, n_stored_vecs, &
                                             isSkewsymmetric_int, wantDebug_int, my_stream) &
                                             bind(C, name="cuda_update_matrix_element_add_double_complex_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t), value  :: vu_stored_rows_dev, uv_stored_cols_dev, a_dev, d_vec_dev
      integer(kind=c_int), intent(in)  :: l_rows, l_cols, matrixRows, max_local_rows, max_local_cols
  ...
  interface
    subroutine cuda_update_array_element_double_complex_c(array_dev, index, value, my_stream) &
                                                  bind(C, name="cuda_update_array_element_double_complex_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t), value  :: array_dev
      integer(kind=c_int), intent(in)  :: index
  ...
  interface
    subroutine cuda_hh_transform_double_complex_c(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug_int, my_stream) &
                                                  bind(C, name="cuda_hh_transform_double_complex_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t), value  :: alpha_dev, xnorm_sq_dev, xf_dev, tau_dev
      integer(kind=c_int), intent(in)  :: wantDebug_int
  ...
  interface
    subroutine cuda_transpose_reduceadd_vectors_copy_block_double_complex_c(aux_transpose_dev, vmat_st_dev, &
                                                  nvc, nvr, n_block, nblks_skip, nblks_tot, &
                                                  lcm_s_t, nblk, auxstride, np_st, ld_st, direction, &
                                                  isSkewsymmetric_int, isReduceadd_int, wantDebug_int, sm_count, my_stream) &
                                                  bind(C, name="cuda_transpose_reduceadd_vectors_copy_block_double_complex_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_T), value  :: aux_transpose_dev, vmat_st_dev
      integer(kind=c_int), intent(in)  :: nvc, nvr, n_block, nblks_skip, nblks_tot, lcm_s_t, nblk, auxstride
  ...
  interface
    subroutine cuda_dot_product_float_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug_int, sm_count, my_stream) &
  ...
  interface
    subroutine cuda_dot_product_and_assign_float_complex_c(v_row_dev, l_rows, isOurProcessRow_int, aux1_dev, &
                                                  wantDebug_int, my_stream) &
                                                  bind(C, name="cuda_dot_product_and_assign_float_complex_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t), value  :: v_row_dev, aux1_dev
      integer(kind=c_int), intent(in)  :: l_rows
  ...
  interface
    subroutine cuda_set_e_vec_scale_set_one_store_v_row_float_complex_c(e_vec_dev, vrl_dev, a_dev, v_row_dev, &
                                     tau_dev, xf_host_or_dev, &
                                     l_rows, l_cols, matrixRows, istep, isOurProcessRow_int, useCCL_int, wantDebug_int, my_stream) &
                                     bind(C, name="cuda_set_e_vec_scale_set_one_store_v_row_float_complex_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t), value  :: e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, xf_host_or_dev
      integer(kind=c_int), intent(in)  :: l_rows, l_cols, matrixRows, istep
  ...
  interface
    subroutine cuda_store_u_v_in_uv_vu_float_complex_c(vu_stored_rows_dev, uv_stored_cols_dev, v_row_dev, u_row_dev, &
                                                  ...
                                                  l_rows, l_cols, n_stored_vecs, max_local_rows, max_local_cols, istep, &
                                                  useCCL_int, wantDebug_int, my_stream) &
                                                  bind(C, name="cuda_store_u_v_in_uv_vu_float_complex_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t), value  :: vu_stored_rows_dev, uv_stored_cols_dev, v_row_dev, u_row_dev
      integer(kind=c_intptr_t), value  :: v_col_dev, u_col_dev, tau_dev, aux_complex_dev
  ...
  interface
    subroutine cuda_update_matrix_element_add_float_complex_c(vu_stored_rows_dev, uv_stored_cols_dev, a_dev, d_vec_dev, &
                                             l_rows, l_cols, matrixRows, max_local_rows, max_local_cols, istep, n_stored_vecs, &
                                             isSkewsymmetric_int, wantDebug_int, my_stream) &
                                             bind(C, name="cuda_update_matrix_element_add_float_complex_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t), value  :: vu_stored_rows_dev, uv_stored_cols_dev, a_dev, d_vec_dev
      integer(kind=c_int), intent(in)  :: l_rows, l_cols, matrixRows, max_local_rows, max_local_cols
  ...
  interface
    subroutine cuda_update_array_element_float_complex_c(array_dev, index, value, my_stream) &
                                                  bind(C, name="cuda_update_array_element_float_complex_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t), value  :: array_dev
      integer(kind=c_int), intent(in)  :: index
  ...
  interface
    subroutine cuda_hh_transform_float_complex_c(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug_int, my_stream) &
                                                  bind(C, name="cuda_hh_transform_float_complex_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_t), value  :: alpha_dev, xnorm_sq_dev, xf_dev, tau_dev
      integer(kind=c_int), intent(in)  :: wantDebug_int
  ...
  interface
    subroutine cuda_transpose_reduceadd_vectors_copy_block_float_complex_c(aux_transpose_dev, vmat_st_dev, &
                                                  nvc, nvr, n_block, nblks_skip, nblks_tot, &
                                                  lcm_s_t, nblk, auxstride, np_st, ld_st, direction, &
                                                  isSkewsymmetric_int, isReduceadd_int, wantDebug_int, sm_count, my_stream) &
                                                  bind(C, name="cuda_transpose_reduceadd_vectors_copy_block_float_complex_FromC")
      use, intrinsic :: iso_c_binding
      implicit none
      integer(kind=c_intptr_T), value  :: aux_transpose_dev, vmat_st_dev
      integer(kind=c_int), intent(in)  :: nvc, nvr, n_block, nblks_skip, nblks_tot, lcm_s_t, nblk, auxstride
  ...
  contains
    ...
    subroutine cuda_dot_product_double(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_dot_product_double_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug_int, sm_count, my_stream)
#endif

    end subroutine

    subroutine cuda_dot_product_and_assign_double(v_row_dev, l_rows, isOurProcessRow, aux1_dev, &
                                                                     wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_dot_product_and_assign_double_c(v_row_dev, l_rows, isOurProcessRow_int, aux1_dev, wantDebug_int, my_stream)
#endif

    end subroutine

    subroutine cuda_set_e_vec_scale_set_one_store_v_row_double(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, &
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_set_e_vec_scale_set_one_store_v_row_double_c(e_vec_dev, vrl_dev, a_dev, &
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_hh_transform_double_c(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug_int, my_stream)
#endif
    ...
    subroutine cuda_dot_product_float(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_dot_product_float_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug_int, sm_count, my_stream)
#endif

    end subroutine

    subroutine cuda_dot_product_and_assign_float(v_row_dev, l_rows, isOurProcessRow, aux1_dev, &
                                                                     wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_dot_product_and_assign_float_c(v_row_dev, l_rows, isOurProcessRow_int, aux1_dev, wantDebug_int, my_stream)
#endif

    end subroutine

    subroutine cuda_set_e_vec_scale_set_one_store_v_row_float(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, &
                                            xf_host_or_dev, l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, &
                                            wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_set_e_vec_scale_set_one_store_v_row_float_c(e_vec_dev, vrl_dev, a_dev, &
                                       v_row_dev, tau_dev, xf_host_or_dev, &
                                       l_rows, l_cols, matrixRows, istep, isOurProcessRow_int, useCCL_int, wantDebug_int, my_stream)
#endif
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_hh_transform_float_c(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug_int, my_stream)
#endif
    ...
    subroutine cuda_dot_product_double_complex(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_dot_product_double_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug_int, sm_count, my_stream)
#endif

    end subroutine

    subroutine cuda_dot_product_and_assign_double_complex(v_row_dev, l_rows, isOurProcessRow, aux1_dev, &
                                                                     wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_dot_product_and_assign_double_complex_c(v_row_dev, l_rows, isOurProcessRow_int, aux1_dev, wantDebug_int, my_stream)
#endif

    end subroutine

    subroutine cuda_set_e_vec_scale_set_one_store_v_row_double_complex(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, &
                                            xf_host_or_dev, l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, &
                                            wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_set_e_vec_scale_set_one_store_v_row_double_complex_c(e_vec_dev, vrl_dev, a_dev, &
                                       v_row_dev, tau_dev, xf_host_or_dev, &
                                       l_rows, l_cols, matrixRows, istep, isOurProcessRow_int, useCCL_int, wantDebug_int, my_stream)
#endif
    ...
    subroutine cuda_update_matrix_element_add_double_complex(vu_stored_rows_dev, uv_stored_cols_dev, a_dev, d_vec_dev,  &
                                            l_rows, l_cols, matrixRows, max_local_rows, max_local_cols, istep, n_stored_vecs, &
                                            isSkewsymmetric, wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_update_matrix_element_add_double_complex_c(vu_stored_rows_dev, uv_stored_cols_dev, a_dev, d_vec_dev,  &
                                       l_rows, l_cols, matrixRows, max_local_rows, max_local_cols, istep, n_stored_vecs, &
                                       isSkewsymmetric_int, wantDebug_int, my_stream)
#endif
    ...
    subroutine cuda_update_array_element_double_complex(array_dev, index, value, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_update_array_element_double_complex_c(array_dev, index, value, my_stream)
#endif

    end subroutine

    subroutine cuda_hh_transform_double_complex(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_hh_transform_double_complex_c(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug_int, my_stream)
#endif

    end subroutine

    subroutine cuda_transpose_reduceadd_vectors_copy_block_double_complex(aux_transpose_dev, vmat_st_dev, &
                                              nvc, nvr, n_block, nblks_skip, nblks_tot, &
                                              lcm_s_t, nblk, auxstride, np_st, ld_st, direction, &
                                              isSkewsymmetric, isReduceadd, wantDebug, sm_count, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_transpose_reduceadd_vectors_copy_block_double_complex_c(aux_transpose_dev, vmat_st_dev, &
                                          nvc, nvr, n_block, nblks_skip, nblks_tot, &
                                          lcm_s_t, nblk, auxstride, np_st, ld_st, direction, &
                                          isSkewsymmetric_int, isReduceadd_int, wantDebug_int, sm_count, my_stream)
#endif
    ...
    subroutine cuda_dot_product_float_complex(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_dot_product_float_complex_c(n, x_dev, incx, y_dev, incy, result_dev, wantDebug_int, sm_count, my_stream)
#endif

    end subroutine

    subroutine cuda_dot_product_and_assign_float_complex(v_row_dev, l_rows, isOurProcessRow, aux1_dev, &
                                                                     wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_dot_product_and_assign_float_complex_c(v_row_dev, l_rows, isOurProcessRow_int, aux1_dev, wantDebug_int, my_stream)
#endif

    end subroutine

    subroutine cuda_set_e_vec_scale_set_one_store_v_row_float_complex(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, &
                                            xf_host_or_dev, l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, &
                                            wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_set_e_vec_scale_set_one_store_v_row_float_complex_c(e_vec_dev, vrl_dev, a_dev, &
                                       v_row_dev, tau_dev, xf_host_or_dev, &
                                       l_rows, l_cols, matrixRows, istep, isOurProcessRow_int, useCCL_int, wantDebug_int, my_stream)
#endif
    ...
    subroutine cuda_update_matrix_element_add_float_complex(vu_stored_rows_dev, uv_stored_cols_dev, a_dev, d_vec_dev,  &
                                            l_rows, l_cols, matrixRows, max_local_rows, max_local_cols, istep, n_stored_vecs, &
                                            isSkewsymmetric, wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_update_matrix_element_add_float_complex_c(vu_stored_rows_dev, uv_stored_cols_dev, a_dev, d_vec_dev,  &
                                       l_rows, l_cols, matrixRows, max_local_rows, max_local_cols, istep, n_stored_vecs, &
                                       isSkewsymmetric_int, wantDebug_int, my_stream)
#endif
    ...
    subroutine cuda_update_array_element_float_complex(array_dev, index, value, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_update_array_element_float_complex_c(array_dev, index, value, my_stream)
#endif

    end subroutine

    subroutine cuda_hh_transform_float_complex(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_hh_transform_float_complex_c(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug_int, my_stream)
#endif

    end subroutine

    subroutine cuda_transpose_reduceadd_vectors_copy_block_float_complex(aux_transpose_dev, vmat_st_dev, &
                                              nvc, nvr, n_block, nblks_skip, nblks_tot, &
                                              lcm_s_t, nblk, auxstride, np_st, ld_st, direction, &
                                              isSkewsymmetric, isReduceadd, wantDebug, sm_count, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_NVIDIA_GPU_VERSION
      call cuda_transpose_reduceadd_vectors_copy_block_float_complex_c(aux_transpose_dev, vmat_st_dev, &
                                          nvc, nvr, n_block, nblks_skip, nblks_tot, &
                                          lcm_s_t, nblk, auxstride, np_st, ld_st, direction, &
                                          isSkewsymmetric_int, isReduceadd_int, wantDebug_int, sm_count, my_stream)
#endif
