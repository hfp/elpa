...
module tridiag_sycl
  ...
  interface
    subroutine sycl_store_u_v_in_uv_vu_double_c(vu_stored_rows_dev, uv_stored_cols_dev, v_row_dev, u_row_dev, &
  ...
  interface
    subroutine sycl_update_array_element_double_c(array_dev, index, value, my_stream) &
  ...
  interface
    subroutine sycl_store_u_v_in_uv_vu_float_c(vu_stored_rows_dev, uv_stored_cols_dev, v_row_dev, u_row_dev, &
                                                  v_col_dev, u_col_dev, tau_dev, aux_complex_dev, &
                                                  vav_host_or_dev, tau_istep_host_or_dev, &
                                                  l_rows, l_cols, n_stored_vecs, max_local_rows, max_local_cols, istep, &
                                                  useCCL_int, wantDebug_int, my_stream) &
  ...
  interface
    subroutine sycl_update_array_element_float_c(array_dev, index, value, my_stream) &
  ...
  interface
    subroutine sycl_store_u_v_in_uv_vu_double_complex_c(vu_stored_rows_dev, uv_stored_cols_dev, v_row_dev, u_row_dev, &
                                                  v_col_dev, u_col_dev, tau_dev, aux_complex_dev, &
                                                  vav_host_or_dev, tau_istep_host_or_dev, &
                                                  l_rows, l_cols, n_stored_vecs, max_local_rows, max_local_cols, istep, &
                                                  useCCL_int, wantDebug_int, my_stream) &
  ...
  interface
    subroutine sycl_update_array_element_double_complex_c(array_dev, index, value, my_stream) &
  ...
  interface
    subroutine sycl_store_u_v_in_uv_vu_float_complex_c(vu_stored_rows_dev, uv_stored_cols_dev, v_row_dev, u_row_dev, &
                                                  v_col_dev, u_col_dev, tau_dev, aux_complex_dev, &
                                                  vav_host_or_dev, tau_istep_host_or_dev, &
                                                  l_rows, l_cols, n_stored_vecs, max_local_rows, max_local_cols, istep, &
                                                  useCCL_int, wantDebug_int, my_stream) &
  ...
  interface
    subroutine sycl_update_array_element_float_complex_c(array_dev, index, value, my_stream) &
  ...
  contains
    ...
    subroutine sycl_dot_product_double(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_set_e_vec_scale_set_one_store_v_row_double(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, &
    ...
    subroutine sycl_store_u_v_in_uv_vu_double(vu_stored_rows_dev, uv_stored_cols_dev, v_row_dev, u_row_dev, &
                                            v_col_dev, u_col_dev, tau_dev, aux_complex_dev, &
                                            vav_host_or_dev, tau_istep_host_or_dev, &
                                            l_rows, l_cols, n_stored_vecs, max_local_rows, max_local_cols, istep, &
    ...
    subroutine sycl_update_matrix_element_add_double(vu_stored_rows_dev, uv_stored_cols_dev, a_dev, d_vec_dev,  &
                                            l_rows, l_cols, matrixRows, max_local_rows, max_local_cols, istep, n_stored_vecs, &
    ...
    subroutine sycl_update_array_element_double(array_dev, index, value, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_SYCL_GPU_VERSION
      call sycl_update_array_element_double_c(array_dev, index, value, my_stream)
#endif

    end subroutine

    subroutine sycl_hh_transform_double(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_transpose_reduceadd_vectors_copy_block_double(aux_transpose_dev, vmat_st_dev, &
                                              nvc, nvr, n_block, nblks_skip, nblks_tot, &
                                              lcm_s_t, nblk, auxstride, np_st, ld_st, direction, &
    ...
    subroutine sycl_copy_and_set_zeros_float(v_row_dev, a_dev, l_rows, l_cols, matrixRows, istep,  &
                                                 aux1_dev, vav_dev, d_vec_dev, &
                                                 isOurProcessRow, isOurProcessCol, isOurProcessCol_prev, &
                                                 isSkewsymmetric, useCCL, wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_dot_product_float(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_set_e_vec_scale_set_one_store_v_row_float(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, &
                                            xf_host_or_dev, l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, &
                                            wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_store_u_v_in_uv_vu_float(vu_stored_rows_dev, uv_stored_cols_dev, v_row_dev, u_row_dev, &
                                            v_col_dev, u_col_dev, tau_dev, aux_complex_dev, &
                                            vav_host_or_dev, tau_istep_host_or_dev, &
                                            l_rows, l_cols, n_stored_vecs, max_local_rows, max_local_cols, istep, &
                                            useCCL, wantDebug, my_stream)
    ...
    subroutine sycl_update_matrix_element_add_float(vu_stored_rows_dev, uv_stored_cols_dev, a_dev, d_vec_dev,  &
                                            l_rows, l_cols, matrixRows, max_local_rows, max_local_cols, istep, n_stored_vecs, &
                                            isSkewsymmetric, wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_update_array_element_float(array_dev, index, value, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_SYCL_GPU_VERSION
      call sycl_update_array_element_float_c(array_dev, index, value, my_stream)
#endif

    end subroutine

    subroutine sycl_hh_transform_float(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_transpose_reduceadd_vectors_copy_block_float(aux_transpose_dev, vmat_st_dev, &
                                              nvc, nvr, n_block, nblks_skip, nblks_tot, &
                                              lcm_s_t, nblk, auxstride, np_st, ld_st, direction, &
                                              isSkewsymmetric, isReduceadd, wantDebug, sm_count, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_copy_and_set_zeros_double_complex(v_row_dev, a_dev, l_rows, l_cols, matrixRows, istep,  &
                                                 aux1_dev, vav_dev, d_vec_dev, &
                                                 isOurProcessRow, isOurProcessCol, isOurProcessCol_prev, &
                                                 isSkewsymmetric, useCCL, wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_dot_product_double_complex(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_set_e_vec_scale_set_one_store_v_row_double_complex(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, &
                                            xf_host_or_dev, l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, &
                                            wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_store_u_v_in_uv_vu_double_complex(vu_stored_rows_dev, uv_stored_cols_dev, v_row_dev, u_row_dev, &
                                            v_col_dev, u_col_dev, tau_dev, aux_complex_dev, &
                                            vav_host_or_dev, tau_istep_host_or_dev, &
                                            l_rows, l_cols, n_stored_vecs, max_local_rows, max_local_cols, istep, &
                                            useCCL, wantDebug, my_stream)
    ...
    subroutine sycl_update_matrix_element_add_double_complex(vu_stored_rows_dev, uv_stored_cols_dev, a_dev, d_vec_dev,  &
                                            l_rows, l_cols, matrixRows, max_local_rows, max_local_cols, istep, n_stored_vecs, &
                                            isSkewsymmetric, wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_update_array_element_double_complex(array_dev, index, value, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_SYCL_GPU_VERSION
      call sycl_update_array_element_double_complex_c(array_dev, index, value, my_stream)
#endif

    end subroutine

    subroutine sycl_hh_transform_double_complex(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_transpose_reduceadd_vectors_copy_block_double_complex(aux_transpose_dev, vmat_st_dev, &
                                              nvc, nvr, n_block, nblks_skip, nblks_tot, &
                                              lcm_s_t, nblk, auxstride, np_st, ld_st, direction, &
                                              isSkewsymmetric, isReduceadd, wantDebug, sm_count, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_copy_and_set_zeros_float_complex(v_row_dev, a_dev, l_rows, l_cols, matrixRows, istep,  &
                                                 aux1_dev, vav_dev, d_vec_dev, &
                                                 isOurProcessRow, isOurProcessCol, isOurProcessCol_prev, &
                                                 isSkewsymmetric, useCCL, wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_dot_product_float_complex(n, x_dev, incx, y_dev, incy, result_dev, wantDebug, sm_count, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_set_e_vec_scale_set_one_store_v_row_float_complex(e_vec_dev, vrl_dev, a_dev, v_row_dev, tau_dev, &
                                            xf_host_or_dev, l_rows, l_cols, matrixRows, istep, isOurProcessRow, useCCL, &
                                            wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_store_u_v_in_uv_vu_float_complex(vu_stored_rows_dev, uv_stored_cols_dev, v_row_dev, u_row_dev, &
                                            v_col_dev, u_col_dev, tau_dev, aux_complex_dev, &
                                            vav_host_or_dev, tau_istep_host_or_dev, &
                                            l_rows, l_cols, n_stored_vecs, max_local_rows, max_local_cols, istep, &
                                            useCCL, wantDebug, my_stream)
    ...
    subroutine sycl_update_matrix_element_add_float_complex(vu_stored_rows_dev, uv_stored_cols_dev, a_dev, d_vec_dev,  &
                                            l_rows, l_cols, matrixRows, max_local_rows, max_local_cols, istep, n_stored_vecs, &
                                            isSkewsymmetric, wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_update_array_element_float_complex(array_dev, index, value, my_stream)
      use, intrinsic :: iso_c_binding
...
#ifdef WITH_SYCL_GPU_VERSION
      call sycl_update_array_element_float_complex_c(array_dev, index, value, my_stream)
#endif

    end subroutine

    subroutine sycl_hh_transform_float_complex(alpha_dev, xnorm_sq_dev, xf_dev, tau_dev, wantDebug, my_stream)
      use, intrinsic :: iso_c_binding
    ...
    subroutine sycl_transpose_reduceadd_vectors_copy_block_float_complex(aux_transpose_dev, vmat_st_dev, &
                                              nvc, nvr, n_block, nblks_skip, nblks_tot, &
                                              lcm_s_t, nblk, auxstride, np_st, ld_st, direction, &
                                              isSkewsymmetric, isReduceadd, wantDebug, sm_count, my_stream)
      use, intrinsic :: iso_c_binding
