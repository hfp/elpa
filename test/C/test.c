...
#if defined(TEST_HERMITIAN_MULTIPLY_FULL) || defined(TEST_PXGEMM_MULTIPLY_NN) || defined(TEST_PXGEMM_MULTIPLY_TN) || defined(TEST_PXGEMM_MULTIPLY_NT) || defined(TEST_PXGEMM_MULTIPLY_TT)
...
#if defined(TEST_DOUBLE)
#if TEST_GPU_DEVICE_POINTER_API == 1
  elpa_pxgemm_multiply_double(handle, trans_a, trans_b, na, a_dev, b_dev, na_rows, na_cols, c_dev, na_rows, na_cols, &error_elpa);
  assert_elpa_ok(error_elpa);
#else
  elpa_pxgemm_multiply_double(handle, trans_a, trans_b, na, a, b, na_rows, na_cols, c, na_rows, na_cols, &error_elpa);
  assert_elpa_ok(error_elpa);
#endif
#endif /* TEST_DOUBLE */
#if defined(TEST_SINGLE)
#if TEST_GPU_DEVICE_POINTER_API == 1
  elpa_pxgemm_multiply_float(handle, trans_a, trans_b, na, a_dev, b_dev, na_rows, na_cols, c_dev, na_rows, na_cols, &error_elpa);
  assert_elpa_ok(error_elpa);
#else
  elpa_pxgemm_multiply_float(handle, trans_a, trans_b, na, a, b, na_rows, na_cols, c, na_rows, na_cols, &error_elpa);
  assert_elpa_ok(error_elpa);
#endif
#endif /* TEST_SINGLE */
#endif /* TEST_REAL */
...
#if defined(TEST_DOUBLE)
#if TEST_GPU_DEVICE_POINTER_API == 1
  elpa_pxgemm_multiply_double_complex(handle, trans_a, trans_b, na, a_dev, b_dev, na_rows, na_cols, c_dev, na_rows, na_cols, &error_elpa);
  assert_elpa_ok(error_elpa);
#else
  elpa_pxgemm_multiply_double_complex(handle, trans_a, trans_b, na, a, b, na_rows, na_cols, c, na_rows, na_cols, &error_elpa);
  assert_elpa_ok(error_elpa);
#endif
#endif /* TEST_DOUBLE */
#if defined(TEST_SINGLE)
#if TEST_GPU_DEVICE_POINTER_API == 1
  elpa_pxgemm_multiply_float_complex(handle, trans_a, trans_b, na, a_dev, b_dev, na_rows, na_cols, c_dev, na_rows, na_cols, &error_elpa);
  assert_elpa_ok(error_elpa);
#else
  elpa_pxgemm_multiply_float_complex(handle, trans_a, trans_b, na, a, b, na_rows, na_cols, c, na_rows, na_cols, &error_elpa);
  assert_elpa_ok(error_elpa);
#endif
#endif /* TEST_SINGLE */
#endif /* TEST_COMPLEX */
...
#else /* TEST_EXPLICIT_NAME */
  elpa_pxgemm_multiply(handle, trans_a, trans_b, na, a, b, na_rows, na_cols, c, na_rows, na_cols, &error_elpa);
  assert_elpa_ok(error_elpa);
#endif /* TEST_EXPLICIT_NAME */
