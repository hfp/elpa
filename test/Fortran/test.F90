...
#if defined(TEST_HERMITIAN_MULTIPLY_FULL) || defined(TEST_HERMITIAN_MULTIPLY_UPPER) || defined(TEST_HERMITIAN_MULTIPLY_LOWER) || defined(TEST_PXGEMM_MULTIPLY_NN) || defined(TEST_PXGEMM_MULTIPLY_TN) || defined(TEST_PXGEMM_MULTIPLY_NT) || defined(TEST_PXGEMM_MULTIPLY_TT)
...
#endif
  do_test_multiply = .false.
#if defined(TEST_MULTIPLY)
  do_test_multiply = .true.
#endif
...
! TEST_MULTIPLY: HERMITIAN_MULTIPLY
...
#if defined(TEST_REAL)
#if defined(TEST_DOUBLE)
  call e%hermitian_multiply_double(uplo_a, uplo_c, &
...
#endif
#if defined(TEST_SINGLE)
  call e%hermitian_multiply_float(uplo_a, uplo_c, &
                            int(na,kind=c_int), a_dev, b_dev, int(na_rows,kind=c_int), &
                            int(na_cols,kind=c_int), c_dev, int(na_rows,kind=c_int), &
                            int(na_cols,kind=c_int), error_elpa)
  assert_elpa_ok(error_elpa)
...
#if defined(TEST_COMPLEX)
#if defined(TEST_DOUBLE)
  call e%hermitian_multiply_double_complex(uplo_a, uplo_c, &
                            int(na,kind=c_int), a_dev, b_dev, int(na_rows,kind=c_int), &
                            int(na_cols,kind=c_int), c_dev, int(na_rows,kind=c_int), &
                            int(na_cols,kind=c_int), error_elpa)
  assert_elpa_ok(error_elpa)
#endif
#if defined(TEST_SINGLE)
  call e%hermitian_multiply_float_complex(uplo_a, uplo_c, &
                            int(na,kind=c_int), a_dev, b_dev, int(na_rows,kind=c_int), &
                            int(na_cols,kind=c_int), c_dev, int(na_rows,kind=c_int), &
                            int(na_cols,kind=c_int), error_elpa)
  assert_elpa_ok(error_elpa)
...
#endif /* TEST_COMPLEX */
#else /* TEST_GPU_DEVICE_POINTER_API */
  call e%hermitian_multiply(uplo_a, uplo_c, &
...
#endif /* defined(TEST_HERMITIAN_MULTIPLY_FULL) || defined(TEST_HERMITIAN_MULTIPLY_UPPER) || defined(TEST_HERMITIAN_MULTIPLY_LOWER) */
...
#endif /* defined(TEST_PXGEMM_MULTIPLY_NN) || defined(TEST_PXGEMM_MULTIPLY_NT) || defined(TEST_PXGEMM_MULTIPLY_TN) || defined(TEST_PXGEMM_MULTIPLY_TT) */
...
#ifdef TEST_MULTIPLY
  if (do_test_multiply) then
    status = check_correctness_multiply(trans_a, trans_b, uplo_a, uplo_c, &
